...
begin
  ...
  begin
    ...
    begin
      ...
      Motor01.O_TurningMotorCounter_ms:=Motor01.O_TurningMotorCounter_ms+Motor01.C_Round_Per_XXXms;
      Motor01.O_TurningGearCounter_ms:=Motor01.O_TurningGearCounter_ms+Motor01.C_GearRound_Per_XXXms;
      ...
      begin
        ...
        Motor01.O_TurningMotorCounter_sec:=Motor01.O_TurningMotorCounter_sec+Motor01.C_Round_Per_sec;
        Motor01.O_TurningGearCounter_sec:=Motor01.O_TurningGearCounter_sec+Motor01.C_GearRound_Per_sec;
      end;
...
begin
  ...
  Motor01.I_RPM:=Abs(SpinEdit1.Value);
...
begin
  ...
  Motor01.I_StopTurningSetpoint:=Abs(SpinEdit2.Value);
end;
...
begin
  ...
  Motor01.I_GearRatio:=Abs(FloatSpinEdit1.Value);
